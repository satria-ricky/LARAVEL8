...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="{{ url('/assetsGuest') }}/assets/css/fontawesome.css">
    <link rel="stylesheet" href="{{ url('/assetsGuest') }}/assets/css/templatemo-seo-dream.css">
    <link rel="stylesheet" href="{{ url('/assetsGuest') }}/assets/css/animated.css">
    <link rel="stylesheet" href="{{ url('/assetsGuest') }}/assets/css/owl.css">
...
<body>
        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <a href="#top" class="logo">
              <h4>Full POWER <img src="{{ url('/assetsGuest') }}/assets/images/logo-icon.png" alt=""></h4>
            </a>
            <!-- ***** Logo End ***** -->
            <!-- ***** Menu Start ***** -->
            <ul class="nav">
              ...
              <li class="scroll-to-section"><div class="main-blue-button"><a href="/sign-in">Sign In</a></div></li> 
            </ul>        
          ...
          <div class="row">
            <div class="col-lg-6 align-self-center">
              <div class="left-content header-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1s">
                <div class="row">
                  ...
                  <div class="col-lg-12">
                    <h2>Give SPORTS its due place in your SCHEDULE!</h2>
                  </div>
                  <div class="col-lg-12">
                    <div class="main-green-button scroll-to-section">
                      <a href="#contact">
                        Find Our Sports Grounds</a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-6">
              <div class="right-image wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                <img src="{{ url('/assetsGuest') }}/assets/images/banner-right-image.png" alt="">
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="left-image wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s">
            <img src="{{ url('/assetsGuest') }}/assets/images/about-left-image.png" alt="">
          </div>
        </div>
        ...
        <div class="col-lg-4">
          <div class="service-item wow bounceInUp" data-wow-duration="1s" data-wow-delay="0.3s">
            <div class="row">
              <div class="col-lg-4">
                <div class="icon">
                  <img src="{{ url('/assetsGuest') }}/assets/images/service-icon-01.png" alt="">
                </div>
              </div>
              <div class="col-lg-8">
        ...
        <div class="col-lg-4">
          <div class="service-item wow bounceInUp" data-wow-duration="1s" data-wow-delay="0.4s">
            <div class="row">
              <div class="col-lg-4">
                <div class="icon">
                  <img src="{{ url('/assetsGuest') }}/assets/images/service-icon-02.png" alt="">
                </div>
              </div>
              <div class="col-lg-8">
                <div class="right-content">
        ...
        <div class="col-lg-4">
          <div class="service-item wow bounceInUp" data-wow-duration="1s" data-wow-delay="0.5s">
            <div class="row">
              <div class="col-lg-4">
                <div class="icon">
                  <img src="{{ url('/assetsGuest') }}/assets/images/service-icon-03.png" alt="">
                </div>
              </div>
              <div class="col-lg-8">
                <div class="right-content">
  ...
  <!-- Scripts -->
  <script src="{{ url('/assetsGuest') }}/vendor/jquery/jquery.min.js"></script>
  <script src="{{ url('/assetsGuest') }}/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
  <script src="{{ url('/assetsGuest') }}/assets/js/owl-carousel.js"></script>
  <script src="{{ url('/assetsGuest') }}/assets/js/animation.js"></script>
  <script src="{{ url('/assetsGuest') }}/assets/js/imagesloaded.js"></script>
  <script src="{{ url('/assetsGuest') }}/assets/js/custom.js"></script>
