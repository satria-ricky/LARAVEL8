                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form role="form" id="forminput1"
                                                ...
                                                <div class="form-group row">
                                                    <label for="inputEmail" class="col-sm-3 col-form-label">Asal Produk
                                                        Jadi</label>
                                                    <div class="col-sm">
                                            ...
                                            @if (Auth::user()->level != 2)
                                                <td>
                                                    <button type="button" id="klikbahankeluar" data-toggle="modal"
                                                        ...
                                                        data-jumlah={{ $row['jumlah'] }} data-sisa={{ $row['sisa'] }}
                        ...
                        <form role="form" id="forminput9" action="{{ url('edit_penerimaanprdukmasuk') }}" method="post">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label" for="inputEmail3"
                                    id="produkmasuk_kadaluarsa">Tanggal
                                    Kadaluarsa</label>
                                <div class="col-sm">
