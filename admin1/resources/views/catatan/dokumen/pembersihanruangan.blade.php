                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="batchnum" class="form-control" id="inputPassword3" placeholder="Batch Number">
                            </div>
                        </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="prosedurnum" class="form-control" id="inputEmail3" placeholder="Prosedur Nomor">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="namaruang" class="form-control" id="inputEmail3" placeholder="Ruangan">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="carabersih" class="form-control" id="inputEmail3" placeholder="Cara Pembersihan">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="pelaksana" class="form-control" id="inputEmail3" placeholder="Pelaksana">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="periksa" class="form-control" id="inputEmail3" placeholder="Diperiksa Oleh">
                            </div>
                        </div>
