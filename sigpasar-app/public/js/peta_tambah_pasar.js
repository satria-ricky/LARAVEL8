...
function getData_peta(){
   ...
   document.getElementById('mapid').innerHTML = "<div id='data_peta' style='height: 400px;'><button type='button' onclick='getLocation()' style='position: absolute; top: 10px; right: 10px; padding: 5px; z-index: 1001; cursor: pointer;' > Gunakan Lokasi Saya</button></div>";
