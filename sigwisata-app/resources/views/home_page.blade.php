...
<head>
    ...
    <link rel="stylesheet" href="{{ url('assets_guest') }}/vendors/owl-carousel/css/owl.carousel.min.css">
    <link rel="stylesheet" href="{{ url('assets_guest') }}/vendors/owl-carousel/css/owl.theme.default.css">
    <link rel="stylesheet" href="{{ url('assets_guest') }}/vendors/mdi/css/materialdesignicons.min.css">
    <link rel="stylesheet" href="{{ url('assets_guest') }}/vendors/aos/css/aos.css">
    <link rel="stylesheet" href="{{ url('assets_guest') }}/css/style.min.css">
...
<body id="body" data-spy="scroll" data-target=".navbar" data-offset="100">
        ...
        <nav class="navbar navbar-expand-lg pl-3 pl-sm-0" id="navbar">
            <div class="container">
                <div class="navbar-brand-wrapper d-flex w-100">
                    <img src="{{ url('assets_guest') }}/images/Group2.svg" alt="">
    ...
    <div class="banner">
        ...
        <button class="btn btn-opacity-success ml-1">Learn more</button>
            ...
            <img src="{{ url('assets_guest') }}/images/Group171.svg" alt="" class="img-fluid">
        </div>
    </div>
    ...
    <script src="{{ url('assets_guest') }}/vendors/jquery/jquery.min.js"></script>
    <script src="{{ url('assets_guest') }}/vendors/bootstrap/bootstrap.min.js"></script>
    <script src="{{ url('assets_guest') }}/vendors/owl-carousel/js/owl.carousel.min.js"></script>
    <script src="{{ url('assets_guest') }}/vendors/aos/js/aos.js"></script>
    <script src="{{ url('assets_guest') }}/js/landingpage.js"></script>
